    ...
    <form className="flex flex-col gap-6" onSubmit={onSubmit}>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <Input label="Experience (Years)" type="number" min="0" step="0.5" placeholder="Enter your Experience.." error={errors.experience_years?.message} {...register("experience_years")} />
        </div>
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <Input label="Qualification" placeholder="Enter your Qualification ..." error={errors.qualification?.message} {...register("qualification")} />
          <Input label="Degree" placeholder="Enter your degree ..." error={errors.degree?.message} {...register("degree")} />
        </div>
      </div>
