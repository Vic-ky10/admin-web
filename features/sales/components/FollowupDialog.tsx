      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-slate-900 shadow-xs outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-100 text-sm"
          >
