...
export default function CustomerDetails({
  ...
  const employeeName = useMemo(() => {
    return employees.find((e) => e.id === customer.assigned_employee_id)?.full_name || "Unassigned";
  }, [employees, customer.assigned_employee_id]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-semibold text-slate-400">Assigned Representative</p>
                  <p className="text-sm font-medium text-slate-700">{employeeName}</p>
                </div>
              </div>
            ...
            {customer.notes && (
              <div className="pt-4 border-t border-slate-100 space-y-1">
                <p className="text-xs font-semibold text-slate-400">Sales Representative Notes</p>
                <div className="rounded-md bg-slate-50 p-3 text-xs text-slate-600 leading-relaxed italic border border-slate-100">
                  {customer.notes}
                </div>
              </div>
            )}
        ...
        {/* Right Side: Purchases and Followup Logs */}
